...
{{- define "otel-demo.domain" -}}
{{- default .Values.dnsName "dev.internal" }}
{{- end }}

{{- define "otel-demo.runtimeEnv" -}}
{{- default .Values.runtimeEnv  "dev" }}
{{- end }}

{{- define "otel-demo.runtimeId" -}}
{{- default .Values.runtimeId "runtime" }}
{{- end }}
